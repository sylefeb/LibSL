// NOTE: this is the MacOS 15 GL header modified for not including
//       functions covered by extensions
...
extern GLboolean glAreTexturesResident (GLsizei n, const GLuint *textures, GLboolean *residences) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glClearAccum (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glClearIndex (GLfloat c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glClearStencil (GLint s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glClipPlane (GLenum plane, const GLdouble *equation) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3b (GLbyte red, GLbyte green, GLbyte blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3bv (const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3d (GLdouble red, GLdouble green, GLdouble blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3f (GLfloat red, GLfloat green, GLfloat blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3i (GLint red, GLint green, GLint blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3s (GLshort red, GLshort green, GLshort blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3ub (GLubyte red, GLubyte green, GLubyte blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3ubv (const GLubyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3ui (GLuint red, GLuint green, GLuint blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3uiv (const GLuint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3us (GLushort red, GLushort green, GLushort blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor3usv (const GLushort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4b (GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4bv (const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4d (GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glColor4i (GLint red, GLint green, GLint blue, GLint alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4s (GLshort red, GLshort green, GLshort blue, GLshort alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4ub (GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4ubv (const GLubyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4ui (GLuint red, GLuint green, GLuint blue, GLuint alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4uiv (const GLuint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4us (GLushort red, GLushort green, GLushort blue, GLushort alpha) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColor4usv (const GLushort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glColorSubTable (GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColorTable (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *table) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColorTableParameterfv (GLenum target, GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glColorTableParameteriv (GLenum target, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionFilter1D (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionFilter2D (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionParameterf (GLenum target, GLenum pname, GLfloat params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionParameterfv (GLenum target, GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionParameteri (GLenum target, GLenum pname, GLint params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glConvolutionParameteriv (GLenum target, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCopyColorSubTable (GLenum target, GLsizei start, GLint x, GLint y, GLsizei width) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCopyColorTable (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCopyConvolutionFilter1D (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCopyConvolutionFilter2D (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCopyPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum type) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glCopyTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glCopyTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glDepthRange (GLclampd zNear, GLclampd zFar) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glDrawBuffer (GLenum mode) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glDrawRangeElements (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEdgeFlag (GLboolean flag) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEdgeFlagPointer (GLsizei stride, const GLvoid *pointer) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEdgeFlagv (const GLboolean *flag) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glEvalCoord1d (GLdouble u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord1dv (const GLdouble *u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord1f (GLfloat u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord1fv (const GLfloat *u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord2d (GLdouble u, GLdouble v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord2dv (const GLdouble *u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord2f (GLfloat u, GLfloat v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalCoord2fv (const GLfloat *u) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalMesh1 (GLenum mode, GLint i1, GLint i2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalMesh2 (GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalPoint1 (GLint i) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEvalPoint2 (GLint i, GLint j) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glFlush (void) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glFogiv (GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glGetClipPlane (GLenum plane, GLdouble *equation) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetColorTable (GLenum target, GLenum format, GLenum type, GLvoid *table) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetColorTableParameterfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetColorTableParameteriv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetConvolutionFilter (GLenum target, GLenum format, GLenum type, GLvoid *image) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetConvolutionParameterfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetConvolutionParameteriv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glGetHistogram (GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetHistogramParameterfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetHistogramParameteriv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glGetLightiv (GLenum light, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMapdv (GLenum target, GLenum query, GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMapfv (GLenum target, GLenum query, GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMapiv (GLenum target, GLenum query, GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMaterialfv (GLenum face, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMaterialiv (GLenum face, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMinmax (GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMinmaxParameterfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetMinmaxParameteriv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetPixelMapfv (GLenum map, GLfloat *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetPixelMapuiv (GLenum map, GLuint *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetPixelMapusv (GLenum map, GLushort *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetPointerv (GLenum pname, GLvoid **params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetPolygonStipple (GLubyte *mask) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetSeparableFilter (GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid *column, GLvoid *span) OPENGL_DEPRECATED(10.0, 10.14);
extern const GLubyte *glGetString (GLenum name) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexEnvfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexEnviv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexGendv (GLenum coord, GLenum pname, GLdouble *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexGenfv (GLenum coord, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexGeniv (GLenum coord, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexImage (GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexLevelParameterfv (GLenum target, GLint level, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexLevelParameteriv (GLenum target, GLint level, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexParameterfv (GLenum target, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetTexParameteriv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glHint (GLenum target, GLenum mode) OPENGL_DEPRECATED(10.0, 10.14);
extern void glHistogram (GLenum target, GLsizei width, GLenum internalformat, GLboolean sink) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexMask (GLuint mask) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexPointer (GLenum type, GLsizei stride, const GLvoid *pointer) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexd (GLdouble c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexdv (const GLdouble *c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexf (GLfloat c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexfv (const GLfloat *c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexi (GLint c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexiv (const GLint *c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexs (GLshort c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexsv (const GLshort *c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexub (GLubyte c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glIndexubv (const GLubyte *c) OPENGL_DEPRECATED(10.0, 10.14);
extern void glInitNames (void) OPENGL_DEPRECATED(10.0, 10.14);
extern void glInterleavedArrays (GLenum format, GLsizei stride, const GLvoid *pointer) OPENGL_DEPRECATED(10.0, 10.14);
extern GLboolean glIsEnabled (GLenum cap) OPENGL_DEPRECATED(10.0, 10.14);
extern GLboolean glIsList (GLuint list) OPENGL_DEPRECATED(10.0, 10.14);
extern GLboolean glIsTexture (GLuint texture) OPENGL_DEPRECATED(10.0, 10.14);
extern void glLightModelf (GLenum pname, GLfloat param) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glLightModeliv (GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glLighti (GLenum light, GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glLightiv (GLenum light, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glLoadName (GLuint name) OPENGL_DEPRECATED(10.0, 10.14);
extern void glLogicOp (GLenum opcode) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMap1d (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMap1f (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMap2d (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMap2f (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMapGrid1d (GLint un, GLdouble u1, GLdouble u2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMapGrid1f (GLint un, GLfloat u1, GLfloat u2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMapGrid2d (GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMapGrid2f (GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glMateriali (GLenum face, GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMaterialiv (GLenum face, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMatrixMode (GLenum mode) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMinmax (GLenum target, GLenum internalformat, GLboolean sink) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glNormal3b (GLbyte nx, GLbyte ny, GLbyte nz) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3bv (const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3d (GLdouble nx, GLdouble ny, GLdouble nz) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3f (GLfloat nx, GLfloat ny, GLfloat nz) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3i (GLint nx, GLint ny, GLint nz) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3s (GLshort nx, GLshort ny, GLshort nz) OPENGL_DEPRECATED(10.0, 10.14);
extern void glNormal3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glPixelMapfv (GLenum map, GLint mapsize, const GLfloat *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPixelMapuiv (GLenum map, GLint mapsize, const GLuint *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPixelMapusv (GLenum map, GLint mapsize, const GLushort *values) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPixelStoref (GLenum pname, GLfloat param) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glPixelTransferi (GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPixelZoom (GLfloat xfactor, GLfloat yfactor) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glPopName (void) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPrioritizeTextures (GLsizei n, const GLuint *textures, const GLclampf *priorities) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glPushName (GLuint name) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2d (GLdouble x, GLdouble y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2f (GLfloat x, GLfloat y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2i (GLint x, GLint y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2s (GLshort x, GLshort y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos2sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos3d (GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glRasterPos3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos3i (GLint x, GLint y, GLint z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos3s (GLshort x, GLshort y, GLshort z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4d (GLdouble x, GLdouble y, GLdouble z, GLdouble w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4f (GLfloat x, GLfloat y, GLfloat z, GLfloat w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4i (GLint x, GLint y, GLint z, GLint w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4s (GLshort x, GLshort y, GLshort z, GLshort w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRasterPos4sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glRectd (GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRectdv (const GLdouble *v1, const GLdouble *v2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRectf (GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRectfv (const GLfloat *v1, const GLfloat *v2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRecti (GLint x1, GLint y1, GLint x2, GLint y2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRectiv (const GLint *v1, const GLint *v2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRects (GLshort x1, GLshort y1, GLshort x2, GLshort y2) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRectsv (const GLshort *v1, const GLshort *v2) OPENGL_DEPRECATED(10.0, 10.14);
extern GLint glRenderMode (GLenum mode) OPENGL_DEPRECATED(10.0, 10.14);
extern void glResetHistogram (GLenum target) OPENGL_DEPRECATED(10.0, 10.14);
extern void glResetMinmax (GLenum target) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRotated (GLdouble angle, GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glRotatef (GLfloat angle, GLfloat x, GLfloat y, GLfloat z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glScaled (GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glSeparableFilter2D (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *column) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glTexCoord1d (GLdouble s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1f (GLfloat s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1i (GLint s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1s (GLshort s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord1sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2d (GLdouble s, GLdouble t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2f (GLfloat s, GLfloat t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2i (GLint s, GLint t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2s (GLshort s, GLshort t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord2sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3d (GLdouble s, GLdouble t, GLdouble r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3f (GLfloat s, GLfloat t, GLfloat r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3i (GLint s, GLint t, GLint r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3s (GLshort s, GLshort t, GLshort r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4d (GLdouble s, GLdouble t, GLdouble r, GLdouble q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4f (GLfloat s, GLfloat t, GLfloat r, GLfloat q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4i (GLint s, GLint t, GLint r, GLint q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4s (GLshort s, GLshort t, GLshort r, GLshort q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexCoord4sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glTexEnvfv (GLenum target, GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexEnvi (GLenum target, GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexEnviv (GLenum target, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGend (GLenum coord, GLenum pname, GLdouble param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGendv (GLenum coord, GLenum pname, const GLdouble *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGenf (GLenum coord, GLenum pname, GLfloat param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGenfv (GLenum coord, GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGeni (GLenum coord, GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexGeniv (GLenum coord, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glTexImage3D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexParameterf (GLenum target, GLenum pname, GLfloat param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexParameterfv (GLenum target, GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexParameteri (GLenum target, GLenum pname, GLint param) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexParameteriv (GLenum target, GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glVertex2dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2f (GLfloat x, GLfloat y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2i (GLint x, GLint y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2s (GLshort x, GLshort y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex2sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex3d (GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glVertex3i (GLint x, GLint y, GLint z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex3s (GLshort x, GLshort y, GLshort z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4d (GLdouble x, GLdouble y, GLdouble z, GLdouble w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4f (GLfloat x, GLfloat y, GLfloat z, GLfloat w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4i (GLint x, GLint y, GLint z, GLint w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4s (GLshort x, GLshort y, GLshort z, GLshort w) OPENGL_DEPRECATED(10.0, 10.14);
extern void glVertex4sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glSampleCoverage (GLclampf value, GLboolean invert) OPENGL_DEPRECATED(10.0, 10.14);

extern void glLoadTransposeMatrixf (const GLfloat *m) OPENGL_DEPRECATED(10.0, 10.14);
extern void glLoadTransposeMatrixd (const GLdouble *m) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultTransposeMatrixf (const GLfloat *m) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultTransposeMatrixd (const GLdouble *m) OPENGL_DEPRECATED(10.0, 10.14);

extern void glCompressedTexImage3D (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCompressedTexImage2D (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCompressedTexImage1D (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCompressedTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCompressedTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glCompressedTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetCompressedTexImage (GLenum target, GLint lod, GLvoid *img) OPENGL_DEPRECATED(10.0, 10.14);

extern void glActiveTexture (GLenum texture) OPENGL_DEPRECATED(10.0, 10.14);
extern void glClientActiveTexture (GLenum texture) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1d (GLenum target, GLdouble s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1dv (GLenum target, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1f (GLenum target, GLfloat s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1fv (GLenum target, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1i (GLenum target, GLint s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1iv (GLenum target, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1s (GLenum target, GLshort s) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord1sv (GLenum target, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2d (GLenum target, GLdouble s, GLdouble t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2dv (GLenum target, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2f (GLenum target, GLfloat s, GLfloat t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2fv (GLenum target, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2i (GLenum target, GLint s, GLint t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2iv (GLenum target, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2s (GLenum target, GLshort s, GLshort t) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord2sv (GLenum target, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3d (GLenum target, GLdouble s, GLdouble t, GLdouble r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3dv (GLenum target, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3f (GLenum target, GLfloat s, GLfloat t, GLfloat r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3fv (GLenum target, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3i (GLenum target, GLint s, GLint t, GLint r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3iv (GLenum target, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3s (GLenum target, GLshort s, GLshort t, GLshort r) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord3sv (GLenum target, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4d (GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4dv (GLenum target, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4f (GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4fv (GLenum target, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4i (GLenum target, GLint s, GLint t, GLint r, GLint q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4iv (GLenum target, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4s (GLenum target, GLshort s, GLshort t, GLshort r, GLshort q) OPENGL_DEPRECATED(10.0, 10.14);
extern void glMultiTexCoord4sv (GLenum target, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);

extern void glFogCoordf (GLfloat coord) OPENGL_DEPRECATED(10.0, 10.14);
extern void glFogCoordfv (const GLfloat *coord);  OPENGL_DEPRECATED(10.0, 10.14)
extern void glFogCoordd (GLdouble coord) OPENGL_DEPRECATED(10.0, 10.14);
extern void glFogCoorddv (const GLdouble *coord);   OPENGL_DEPRECATED(10.0, 10.14)
extern void glFogCoordPointer (GLenum type, GLsizei stride, const GLvoid *pointer) OPENGL_DEPRECATED(10.0, 10.14);

extern void glSecondaryColor3b (GLbyte red, GLbyte green, GLbyte blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3bv (const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3d (GLdouble red, GLdouble green, GLdouble blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3f (GLfloat red, GLfloat green, GLfloat blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3i (GLint red, GLint green, GLint blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3s (GLshort red, GLshort green, GLshort blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3ub (GLubyte red, GLubyte green, GLubyte blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3ubv (const GLubyte *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3ui (GLuint red, GLuint green, GLuint blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3uiv (const GLuint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3us (GLushort red, GLushort green, GLushort blue) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColor3usv (const GLushort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glSecondaryColorPointer (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer) OPENGL_DEPRECATED(10.0, 10.14);

extern void glPointParameterf (GLenum pname, GLfloat param); OPENGL_DEPRECATED(10.0, 10.14)
extern void glPointParameterfv (GLenum pname, const GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
extern void glPointParameteri (GLenum pname, GLint param); OPENGL_DEPRECATED(10.0, 10.14)
extern void glPointParameteriv (GLenum pname, const GLint *params) OPENGL_DEPRECATED(10.0, 10.14);

extern void glBlendFuncSeparate (GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) OPENGL_DEPRECATED(10.0, 10.14);

extern void glMultiDrawArrays (GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount) OPENGL_DEPRECATED(10.0, 10.14);
...
extern void glWindowPos2d (GLdouble x, GLdouble y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2f (GLfloat x, GLfloat y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2i (GLint x, GLint y); OPENGL_DEPRECATED(10.0, 10.14)
extern void glWindowPos2iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2s (GLshort x, GLshort y) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos2sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3d (GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3dv (const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3f (GLfloat x, GLfloat y, GLfloat z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3fv (const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3i (GLint x, GLint y, GLint z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3iv (const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3s (GLshort x, GLshort y, GLshort z) OPENGL_DEPRECATED(10.0, 10.14);
extern void glWindowPos3sv (const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);

extern void glGenQueries (GLsizei n, GLuint *ids) OPENGL_DEPRECATED(10.0, 10.14);
extern void glDeleteQueries (GLsizei n, const GLuint *ids) OPENGL_DEPRECATED(10.0, 10.14);
extern GLboolean glIsQuery (GLuint id) OPENGL_DEPRECATED(10.0, 10.14);
extern void glBeginQuery (GLenum target, GLuint id) OPENGL_DEPRECATED(10.0, 10.14);
extern void glEndQuery (GLenum target) OPENGL_DEPRECATED(10.0, 10.14);
extern void glGetQueryiv (GLenum target, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
...
// extern void glVertexAttrib1fv (GLuint index, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib1s (GLuint index, GLshort x) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib1sv (GLuint index, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2d (GLuint index, GLdouble x, GLdouble y) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2dv (GLuint index, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2f (GLuint index, GLfloat x, GLfloat y) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2fv (GLuint index, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2s (GLuint index, GLshort x, GLshort y) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib2sv (GLuint index, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3d (GLuint index, GLdouble x, GLdouble y, GLdouble z) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3dv (GLuint index, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3f (GLuint index, GLfloat x, GLfloat y, GLfloat z) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3fv (GLuint index, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3s (GLuint index, GLshort x, GLshort y, GLshort z) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib3sv (GLuint index, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nbv (GLuint index, const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Niv (GLuint index, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nsv (GLuint index, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nub (GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nubv (GLuint index, const GLubyte *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nuiv (GLuint index, const GLuint *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4Nusv (GLuint index, const GLushort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4bv (GLuint index, const GLbyte *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4d (GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4dv (GLuint index, const GLdouble *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4f (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4fv (GLuint index, const GLfloat *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4iv (GLuint index, const GLint *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4s (GLuint index, GLshort x, GLshort y, GLshort z, GLshort w) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4sv (GLuint index, const GLshort *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4ubv (GLuint index, const GLubyte *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4uiv (GLuint index, const GLuint *v) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glVertexAttrib4usv (GLuint index, const GLushort *v) OPENGL_DEPRECATED(10.0, 10.14);
...
// extern void glDisableVertexAttribArray (GLuint index) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetVertexAttribdv (GLuint index, GLenum pname, GLdouble *params) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetVertexAttribfv (GLuint index, GLenum pname, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetVertexAttribiv (GLuint index, GLenum pname, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetVertexAttribPointerv (GLuint index, GLenum pname, GLvoid **pointer) OPENGL_DEPRECATED(10.0, 10.14);
...
// extern void glValidateProgram (GLuint program) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform1f (GLint location, GLfloat v0) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform2f (GLint location, GLfloat v0, GLfloat v1) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform3f (GLint location, GLfloat v0, GLfloat v1, GLfloat v2) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform4f (GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform1i (GLint location, GLint v0) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform2i (GLint location, GLint v0, GLint v1) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform3i (GLint location, GLint v0, GLint v1, GLint v2) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform4i (GLint location, GLint v0, GLint v1, GLint v2, GLint v3) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform1fv (GLint location, GLsizei count, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform2fv (GLint location, GLsizei count, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform3fv (GLint location, GLsizei count, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform4fv (GLint location, GLsizei count, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform1iv (GLint location, GLsizei count, const GLint *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform2iv (GLint location, GLsizei count, const GLint *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform3iv (GLint location, GLsizei count, const GLint *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniform4iv (GLint location, GLsizei count, const GLint *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix2fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix3fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix4fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern GLboolean glIsShader (GLuint shader) OPENGL_DEPRECATED(10.0, 10.14);
// extern GLboolean glIsProgram (GLuint program) OPENGL_DEPRECATED(10.0, 10.14);
...
// extern void glGetAttachedShaders (GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders) OPENGL_DEPRECATED(10.0, 10.14);
...
// extern void glGetActiveUniform (GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetUniformfv (GLuint program, GLint location, GLfloat *params) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetUniformiv (GLuint program, GLint location, GLint *params) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetShaderSource (GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glBindAttribLocation (GLuint program, GLuint index, const GLchar *name) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glGetActiveAttrib (GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name) OPENGL_DEPRECATED(10.0, 10.14);
// extern GLint glGetAttribLocation (GLuint program, const GLchar *name) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glStencilFuncSeparate (GLenum face, GLenum func, GLint ref, GLuint mask) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glStencilOpSeparate (GLenum face, GLenum fail, GLenum zfail, GLenum zpass) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glStencilMaskSeparate (GLenum face, GLuint mask) OPENGL_DEPRECATED(10.0, 10.14);

// extern void glUniformMatrix2x3fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix3x2fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix2x4fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix4x2fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix3x4fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
// extern void glUniformMatrix4x3fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) OPENGL_DEPRECATED(10.0, 10.14);
