...
########################################
	SET(LIBSL_LIBRARIES         LibSL)

	if (NOT EMSCRIPTEN)
	  SET(LIBSL_GL_LIBRARIES      LibSL_gl glux)
	else ()
	  SET(LIBSL_GL4_LIBRARIES     LibSL_gl)
	endif ()

	SET(LIBSL_GL4_LIBRARIES     LibSL_gl4)

	SET(LIBSL_GL4CORE_LIBRARIES LibSL_gl4core)

	SET(LIBSL_LINALG_LIBRARIES  LibSL_linalg)

########################################
IF (NOT TARGET LibSL)
  ADD_LIBRARY(LibSL STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL PROPERTY IMPORTED_LOCATION_DEBUG
	${LIBSL_LIBRARY_DIR}/libLibSL-d.a)
  SET_PROPERTY(TARGET LibSL PROPERTY IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG
	${LIBSL_LIBRARY_DIR}/libjpeg-d.a
	${LIBSL_LIBRARY_DIR}/libpng-d.a
	${LIBSL_LIBRARY_DIR}/libzlib-d.a
	${LIBSL_LIBRARY_DIR}/libloki-d.a
	${LIBSL_LIBRARY_DIR}/lib3ds-d.a
	${LIBSL_LIBRARY_DIR}/libtinyxml-d.a
	${LIBSL_LIBRARY_DIR}/libhashlibpp-d.a
	${LIBSL_LIBRARY_DIR}/libqhull-d.a
  )
...
IF (NOT TARGET AntTweakBar)
  ...
  SET_PROPERTY(TARGET AntTweakBar PROPERTY IMPORTED_LOCATION_DEBUG
	${LIBSL_LIBRARY_DIR}/libAntTweakBar-d.a)
  SET_PROPERTY(TARGET AntTweakBar PROPERTY IMPORTED_LOCATION_RELEASE
...
IF (NOT TARGET glux)
  ADD_LIBRARY(glux STATIC IMPORTED)
  SET_PROPERTY(TARGET glux PROPERTY IMPORTED_LOCATION_DEBUG ${LIBSL_LIBRARY_DIR}/libglux-d.a)
  SET_PROPERTY(TARGET glux PROPERTY IMPORTED_LOCATION_RELEASE ${LIBSL_LIBRARY_DIR}/libglux.a)
ENDIF ()

########################################
IF (NOT TARGET LibSL_gl)
  ADD_LIBRARY(LibSL_gl STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL_gl PROPERTY IMPORTED_LOCATION_DEBUG	${LIBSL_LIBRARY_DIR}/libLibSL_gl-d.a)
  SET_PROPERTY(TARGET LibSL_gl PROPERTY IMPORTED_LOCATION_RELEASE	${LIBSL_LIBRARY_DIR}/libLibSL_gl.a)
  IF (NOT EMSCRIPTEN)
...
IF (NOT TARGET LibSL_gl4)
  ADD_LIBRARY(LibSL_gl4 STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL_gl4 PROPERTY IMPORTED_LOCATION_DEBUG
	${LIBSL_LIBRARY_DIR}/libLibSL_gl4-d.a)
  SET_PROPERTY(TARGET LibSL_gl4 PROPERTY IMPORTED_LOCATION_RELEASE
...
IF (NOT TARGET LibSL_gl4core)
  ADD_LIBRARY(LibSL_gl4core STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL_gl4core PROPERTY IMPORTED_LOCATION_DEBUG
	${LIBSL_LIBRARY_DIR}/libLibSL_gl4core-d.a)
  SET_PROPERTY(TARGET LibSL_gl4core PROPERTY IMPORTED_LOCATION_RELEASE
...
IF (NOT TARGET LibSL_linalg)
  ADD_LIBRARY(LibSL_linalg STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL_linalg PROPERTY IMPORTED_LOCATION_DEBUG
	${LIBSL_LIBRARY_DIR}/libLibSL_linalg-d.a)
  SET_PROPERTY(TARGET LibSL_linalg PROPERTY IMPORTED_LOCATION_RELEASE
	${LIBSL_LIBRARY_DIR}/libLibSL_linalg.a)
  SET_PROPERTY(TARGET LibSL_linalg PROPERTY IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG
	${LIBSL_LIBRARY_DIR}/libnl-d.a)
  SET_PROPERTY(TARGET LibSL_linalg PROPERTY IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE
